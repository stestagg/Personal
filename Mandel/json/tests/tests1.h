...
tst tests[]={
	...
	{"UTF8 mmap Buffer","Creates a mmapped UFT8 buffer.  Will fail if test.json does not exist.",UTF_test::buffer3,false,false},
	{"UTF8 mmap Buffer","Checks that mmapped buffers get unmapped.",UTF_test::buffer4,false,true},
